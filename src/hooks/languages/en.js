...
export const en = {
  ...
  hero_subtitle:
    "Reach the ultimate goal of swimming in open ocean with the help of our professional coach",
...
faq:"FAQ",
faq_q_1:"Can beginners join?",
faq_a_1:"Of course! Our academy was created specifically so that anyone, even if they have never swum before, can confidently start their journey in the water. We don't just teach you how to swim; we help you overcome any fears and learn to feel comfortable and safe. Our coach specializes in working with beginners, so your lessons will start with the absolute fundamentals—proper breathing, body position in the water, and basic exercises. Everything progresses at a calm, supportive pace, step by step. It doesn't matter where you're starting from; what matters is that you're taking this incredibly important first step, and we'll be right there with you to help you achieve your goal.",
faq_q_2:"How much for the trial session?",
faq_a_2: "We offer a one-time trial session for 250,000 IDR. This session is designed to give you a genuine feel for our teaching method, a personal assessment from our coach, and a clear path toward your swimming goals. Keep in mind that this is non-refundable.",
faq_q_3:"Can I choose when to have my lessons?",
faq_a_3:"Absolutely! We believe that learning should fit your life, not the other way around. That's why we offer flexible scheduling for our lessons. Whether you prefer mornings, evenings, or weekends, we'll do our best to accommodate you and ensure your learning journey is both convenient and effective.",
faq_q_4:"Where do we swim?",
faq_a_4_part1: "Students can choose from two swimming pool locations for their lessons. One is in Jimbaran and is called",
faq_a_4_part2: "The other is in Berawa and is called",
